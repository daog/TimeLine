	...
	private void setData() {
		  ...
		  if (AppContext.getUser().getGender().equals("1")) {
			...
			sexualView.setText("女");
			  ...
			  departmentView.setText(AppContext.getUser().getDepartment()!=null?AppContext.getUser().getDepartment():"(未填写)");
			  dutyView.setText(AppContext.getUser().getPosition()!=null?AppContext.getInstance().jonbase.getPosition().get(AppContext.getUser().getPosition()):"(未填写)" );
		  
		  
		  jobtitleView.setText(AppContext.getUser().getJob_title()!=null?AppContext.getInstance().jonbase.getJob_title().get(AppContext.getUser().getJob_title()):"(未填写)");
		  hospitalView.setText(AppContext.getUser().getInstitution()!=null?AppContext.getUser().getInstitution():"(未填写)");
	}
