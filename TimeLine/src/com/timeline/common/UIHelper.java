...
import com.timeline.ui.JobListAc;
...
import com.timeline.ui.MySigninReadyAc;
...
import com.timeline.ui.SettingPawAc;
import com.timeline.ui.WebviewAc;
...
private final static String TAG = "UIHelper";
	 ...
	 * @param activity
	 */
	public static void showMeetingDetail(Activity activity,String id) {
	...
	public static void showMySign(Activity activity) {
		if (AppContext.getInstance().getIslogin()) {
			Intent intent = new Intent(activity, MySigninReadyAc.class);
			activity.startActivity(intent);
		}
		else {
	 ...
	 * @param activity
	 */
	public static void showNewEvent(Activity activity, MeetingInfo mi) {
		Intent intent = new Intent(activity, EventAddAc.class);
		Bundle mBundle = new Bundle();    
        mBundle.putSerializable("meetingInfo", mi); 
	 ...
	 * @param activity
	 */
	public static void showEventDe(Activity activity,String Id) {
		Intent intent = new Intent(activity, EventDeAc.class);
		intent.putExtra("id", Id);
		activity.startActivity(intent);
	}
	 ...
	 * @param activity
	 */
	public static void showRegister1(Activity activity,String type) {
	 ...
	 * @param activity
	 */
	public static void showRegister2(Activity activity,String type) {
	 ...
	 * @param activity
	 */
	public static void showJobList(Activity activity,String type) {
		Intent intent = new Intent(activity, JobListAc.class);
		intent.putExtra("type", type);
		activity.startActivity(intent);
	}
	 ...
	 * @param activity
	 */
	public static void showPawSet(Activity activity) {
		Intent intent = new Intent(activity, SettingPawAc.class);
		activity.startActivity(intent);
	}
	...
	public static void showSearch(Activity activity) {
		Intent intent = new Intent(activity, SearchAc.class);
		activity.startActivity(intent);
	}
	 ...
	 * @param activity
	 */
	public static void showWebview(String type,Activity activity) {
		Intent intent = new Intent(activity, WebviewAc.class);
		intent.putExtra("type", type);
		activity.startActivity(intent);
	}
	/**
